$("document").ready(function(){
 ...
 $.ajax({
        ...
        method: "POST",
            ...
            crossDomain: true,
            url: "http://telecommit.altervista.org/Telecommit/php/get_health.php", //Relative or absolute path to file.php file
...
function insert_into_row(health, index) {
    ...
    row+="</tr>";
    row+="<tr><td align='center'><a href='get_tablet.html?tablet=" +health[index].id+ "' class='animation animated-item-3' role='button'>VIEW</a></td></tr>";
    row+="</table></div>";
