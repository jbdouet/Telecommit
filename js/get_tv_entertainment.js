$("document").ready(function(){
 ...
 $.ajax({
        ...
        method: "POST",
            ...
            crossDomain: true,
            url: "http://telecommit.altervista.org/Telecommit/php/get_tv_entertainment.php", //Relative or absolute path to file.php file
...
function insert_into_row(tv, index) {
    ...
    row+="</tr>";
    row+="<tr><td align='center'><a href='get_tablet.html?tablet=" +tv[index].id+ "' class='animation animated-item-3' role='button'>VIEW</a></td></tr>";
    row+="</table></div>";
