$("document").ready(function(){
 ...
 $.ajax({
        ...
        method: "POST",
            ...
            crossDomain: true,
            url: "http://telecommit.altervista.org/Telecommit/php/get_modem_networking.php", //Relative or absolute path to file.php file
...
function insert_into_row(modem, index) {
    ...
    row+="</tr>";
    row+="<tr><td align='center'><a href='get_tablet.html?tablet=" +modem[index].id+ "' class='animation animated-item-3' role='button'>VIEW</a></td></tr>";
    row+="</table></div>";
